...
#define adminCMDInterrupt 16 //for when admin parent gives command
...
int submit_process (char* fname, int sockfd);  // called by submit.c
...
//void process_admin_commands (int numR, int readAddr);
